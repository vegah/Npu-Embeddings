module {
  aie.device(npu2) {
    ...
    %B_L3L2_cons_buff_0 = aie.buffer(%mem_tile_0_1) {address = 262144 : i32, mem_bank = 4 : i32, sym_name = "B_L3L2_cons_buff_0"} : memref<2048xbf16> 
    %B_L3L2_cons_buff_1 = aie.buffer(%mem_tile_0_1) {address = 327680 : i32, mem_bank = 5 : i32, sym_name = "B_L3L2_cons_buff_1"} : memref<2048xbf16> 
    %B_L3L2_cons_prod_lock_0 = aie.lock(%mem_tile_0_1, 4) {init = 2 : i32, sym_name = "B_L3L2_cons_prod_lock_0"}
    %B_L3L2_cons_cons_lock_0 = aie.lock(%mem_tile_0_1, 5) {init = 0 : i32, sym_name = "B_L3L2_cons_cons_lock_0"}
    %C_L1L2_buff_0 = aie.buffer(%tile_0_2) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "C_L1L2_buff_0"} : memref<2048xf32> 
    %C_L1L2_buff_1 = aie.buffer(%tile_0_2) {address = 16384 : i32, mem_bank = 1 : i32, sym_name = "C_L1L2_buff_1"} : memref<2048xf32> 
    ...
    %B_L2L1_cons_buff_0 = aie.buffer(%tile_0_2) {address = 9216 : i32, mem_bank = 0 : i32, sym_name = "B_L2L1_cons_buff_0"} : memref<2048xbf16> 
    %B_L2L1_cons_buff_1 = aie.buffer(%tile_0_2) {address = 24576 : i32, mem_bank = 1 : i32, sym_name = "B_L2L1_cons_buff_1"} : memref<2048xbf16> 
    ...
    %C_L1L2_cons_buff_0 = aie.buffer(%mem_tile_0_1) {address = 0 : i32, mem_bank = 0 : i32, sym_name = "C_L1L2_cons_buff_0"} : memref<2048xf32> 
    %C_L1L2_cons_buff_1 = aie.buffer(%mem_tile_0_1) {address = 65536 : i32, mem_bank = 1 : i32, sym_name = "C_L1L2_cons_buff_1"} : memref<2048xf32> 
    %C_L1L2_cons_prod_lock_0 = aie.lock(%mem_tile_0_1, 2) {init = 2 : i32, sym_name = "C_L1L2_cons_prod_lock_0"}
    %C_L1L2_cons_cons_lock_0 = aie.lock(%mem_tile_0_1, 3) {init = 0 : i32, sym_name = "C_L1L2_cons_cons_lock_0"}
    %A_L3L2_cons_buff_0 = aie.buffer(%mem_tile_0_1) {address = 131072 : i32, mem_bank = 2 : i32, sym_name = "A_L3L2_cons_buff_0"} : memref<4096xbf16> 
    %A_L3L2_cons_buff_1 = aie.buffer(%mem_tile_0_1) {address = 196608 : i32, mem_bank = 3 : i32, sym_name = "A_L3L2_cons_buff_1"} : memref<4096xbf16> 
    ...
    %A_L2L1_cons_buff_0 = aie.buffer(%tile_0_2) {address = 32768 : i32, mem_bank = 2 : i32, sym_name = "A_L2L1_cons_buff_0"} : memref<4096xbf16> 
    %A_L2L1_cons_buff_1 = aie.buffer(%tile_0_2) {address = 49152 : i32, mem_bank = 3 : i32, sym_name = "A_L2L1_cons_buff_1"} : memref<4096xbf16> 
    ...
    func.func private @"0c5c718d_matmul_bf16_f32"(memref<4096xbf16>, memref<2048xbf16>, memref<2048xf32>) attributes {link_with = "matmul_bf16_f32_0c5c718d.o"}
    %_anonymous0 = aie.buffer(%tile_0_2) {address = 40960 : i32, mem_bank = 2 : i32, sym_name = "_anonymous0"} : memref<3xi32> 
    ...
    ^bb5:  // pred: ^bb4
      cf.br ^bb8(%C_L1L2_buff_0 : memref<2048xf32>)
    ^bb6:  // pred: ^bb4
      cf.br ^bb8(%C_L1L2_buff_1 : memref<2048xf32>)
    ^bb7:  // pred: ^bb4
      cf.br ^bb8(%C_L1L2_buff_0 : memref<2048xf32>)
    ^bb8(%7: memref<2048xf32>):  // 3 preds: ^bb5, ^bb6, ^bb7
      cf.br ^bb9(%c0 : index)
    ^bb9(%8: index):  // 2 preds: ^bb8, ^bb10
      %9 = arith.cmpi slt, %8, %c2048 : index
      cf.cond_br %9, ^bb10, ^bb11
    ^bb10:  // pred: ^bb9
      memref.store %cst, %7[%8] : memref<2048xf32>
      %10 = arith.addi %8, %c1 : index
      cf.br ^bb9(%10 : index)
    ^bb11:  // pred: ^bb9
      cf.br ^bb12(%c0 : index)
    ^bb12(%11: index):  // 2 preds: ^bb11, ^bb21
      %12 = arith.cmpi slt, %11, %c6 : index
    ...
    ^bb18:  // pred: ^bb17
      cf.br ^bb21(%B_L2L1_cons_buff_0 : memref<2048xbf16>)
    ^bb19:  // pred: ^bb17
      cf.br ^bb21(%B_L2L1_cons_buff_1 : memref<2048xbf16>)
    ^bb20:  // pred: ^bb17
      cf.br ^bb21(%B_L2L1_cons_buff_0 : memref<2048xbf16>)
    ^bb21(%20: memref<2048xbf16>):  // 3 preds: ^bb18, ^bb19, ^bb20
      func.call @"0c5c718d_matmul_bf16_f32"(%16, %20, %7) : (memref<4096xbf16>, memref<2048xbf16>, memref<2048xf32>) -> ()
    ...
    ^bb24:  // pred: ^bb1
      aie.end
    } {link_files = ["matmul_bf16_f32_0c5c718d.o"]}
    ...
    aie.runtime_sequence(%arg0: memref<256x384xbf16>, %arg1: memref<384x1152xbf16>, %arg2: memref<256x1152xf32>) {
      ...
      %0 = aiex.dma_configure_task_for @A_L3L2_shim_alloc {
        aie.dma_bd(%arg0 : memref<256x384xbf16>, 0, 24576, [<size = 36, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 35 : i32}
      aiex.dma_start_task(%0)
      %1 = aiex.dma_configure_task_for @B_L3L2_shim_alloc {
        aie.dma_bd(%arg1 : memref<384x1152xbf16>, 0, 442368, [<size = 1, stride = 0>, <size = 36, stride = 32>, <size = 384, stride = 1152>, <size = 32, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%1)
      %2 = aiex.dma_configure_task_for @C_L2L3_shim_alloc {
        aie.dma_bd(%arg2 : memref<256x1152xf32>, 0, 73728, [<size = 1, stride = 0>, <size = 36, stride = 32>, <size = 64, stride = 1152>, <size = 32, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      ...
      %3 = aiex.dma_configure_task_for @A_L3L2_shim_alloc {
        aie.dma_bd(%arg0 : memref<256x384xbf16>, 24576, 24576, [<size = 36, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 35 : i32}
      ...
      %5 = aiex.dma_configure_task_for @C_L2L3_shim_alloc {
        aie.dma_bd(%arg2 : memref<256x1152xf32>, 73728, 73728, [<size = 1, stride = 0>, <size = 36, stride = 32>, <size = 64, stride = 1152>, <size = 32, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      ...
      %6 = aiex.dma_configure_task_for @A_L3L2_shim_alloc {
        aie.dma_bd(%arg0 : memref<256x384xbf16>, 49152, 24576, [<size = 36, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 35 : i32}
      ...
      %8 = aiex.dma_configure_task_for @C_L2L3_shim_alloc {
        aie.dma_bd(%arg2 : memref<256x1152xf32>, 147456, 73728, [<size = 1, stride = 0>, <size = 36, stride = 32>, <size = 64, stride = 1152>, <size = 32, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      ...
      %9 = aiex.dma_configure_task_for @A_L3L2_shim_alloc {
        aie.dma_bd(%arg0 : memref<256x384xbf16>, 73728, 24576, [<size = 36, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 35 : i32}
      ...
      %11 = aiex.dma_configure_task_for @C_L2L3_shim_alloc {
        aie.dma_bd(%arg2 : memref<256x1152xf32>, 221184, 73728, [<size = 1, stride = 0>, <size = 36, stride = 32>, <size = 64, stride = 1152>, <size = 32, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.dma_bd(%A_L3L2_cons_buff_0 : memref<4096xbf16>, 0, 4096, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%A_L3L2_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%A_L3L2_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%A_L3L2_cons_buff_1 : memref<4096xbf16>, 0, 4096, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {bd_id = 1 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%A_L3L2_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb3:  // pred: ^bb0
    ...
    ^bb7:  // 2 preds: ^bb6, ^bb8
      ...
      aie.dma_bd(%B_L3L2_cons_buff_0 : memref<2048xbf16>, 0, 2048, [<size = 8, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>]) {bd_id = 24 : i32, next_bd_id = 25 : i32}
      aie.use_lock(%B_L3L2_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb8
    ^bb8:  // pred: ^bb7
      aie.use_lock(%B_L3L2_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%B_L3L2_cons_buff_1 : memref<2048xbf16>, 0, 2048, [<size = 8, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>]) {bd_id = 25 : i32, next_bd_id = 24 : i32}
      aie.use_lock(%B_L3L2_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb7
    ^bb9:  // pred: ^bb6
    ...
    ^bb10:  // 2 preds: ^bb9, ^bb11
      ...
      aie.dma_bd(%B_L3L2_cons_buff_0 : memref<2048xbf16>, 0, 2048) {bd_id = 26 : i32, next_bd_id = 27 : i32}
      aie.use_lock(%B_L3L2_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb11
    ^bb11:  // pred: ^bb10
      aie.use_lock(%B_L3L2_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%B_L3L2_cons_buff_1 : memref<2048xbf16>, 0, 2048) {bd_id = 27 : i32, next_bd_id = 26 : i32}
      aie.use_lock(%B_L3L2_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb10
    ^bb12:  // pred: ^bb9
    ...
    ^bb13:  // 2 preds: ^bb12, ^bb14
      ...
      aie.dma_bd(%C_L1L2_cons_buff_0 : memref<2048xf32>, 0, 2048) {bd_id = 4 : i32, next_bd_id = 5 : i32}
      aie.use_lock(%C_L1L2_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb14
    ^bb14:  // pred: ^bb13
      aie.use_lock(%C_L1L2_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%C_L1L2_cons_buff_1 : memref<2048xf32>, 0, 2048) {bd_id = 5 : i32, next_bd_id = 4 : i32}
      aie.use_lock(%C_L1L2_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb13
    ^bb15:  // pred: ^bb12
    ...
    ^bb16:  // 2 preds: ^bb15, ^bb17
      ...
      aie.dma_bd(%C_L1L2_cons_buff_0 : memref<2048xf32>, 0, 2048, [<size = 8, stride = 256>, <size = 8, stride = 8>, <size = 4, stride = 64>, <size = 8, stride = 1>]) {bd_id = 6 : i32, next_bd_id = 7 : i32}
      aie.use_lock(%C_L1L2_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb17
    ^bb17:  // pred: ^bb16
      aie.use_lock(%C_L1L2_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%C_L1L2_cons_buff_1 : memref<2048xf32>, 0, 2048, [<size = 8, stride = 256>, <size = 8, stride = 8>, <size = 4, stride = 64>, <size = 8, stride = 1>]) {bd_id = 7 : i32, next_bd_id = 6 : i32}
      aie.use_lock(%C_L1L2_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb16
    ^bb18:  // pred: ^bb15
      aie.end
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb5
      ...
      aie.dma_bd(%B_L2L1_cons_buff_0 : memref<2048xbf16>, 0, 2048) {bd_id = 2 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%B_L2L1_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb5
    ^bb5:  // pred: ^bb4
      aie.use_lock(%B_L2L1_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%B_L2L1_cons_buff_1 : memref<2048xbf16>, 0, 2048) {bd_id = 3 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%B_L2L1_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb4
    ^bb6:  // pred: ^bb3
    ...
    ^bb7:  // 2 preds: ^bb6, ^bb8
      ...
      aie.dma_bd(%C_L1L2_buff_0 : memref<2048xf32>, 0, 2048) {bd_id = 4 : i32, next_bd_id = 5 : i32}
      aie.use_lock(%C_L1L2_prod_lock_0, Release, 1)
      aie.next_bd ^bb8
    ^bb8:  // pred: ^bb7
      aie.use_lock(%C_L1L2_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%C_L1L2_buff_1 : memref<2048xf32>, 0, 2048) {bd_id = 5 : i32, next_bd_id = 4 : i32}
      aie.use_lock(%C_L1L2_prod_lock_0, Release, 1)
      aie.next_bd ^bb7
    ^bb9:  // pred: ^bb6
      aie.end
