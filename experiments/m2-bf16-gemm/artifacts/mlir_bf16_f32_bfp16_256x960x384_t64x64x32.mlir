module {
  aie.device(npu2) {
    ...
    ^bb12(%11: index):  // 2 preds: ^bb11, ^bb21
      %12 = arith.cmpi slt, %11, %c15 : index
    ...
    aie.runtime_sequence(%arg0: memref<256x960xbf16>, %arg1: memref<960x384xbf16>, %arg2: memref<256x384xf32>) {
      ...
      %0 = aiex.dma_configure_task_for @A_L3L2_shim_alloc {
        aie.dma_bd(%arg0 : memref<256x960xbf16>, 0, 61440, [<size = 12, stride = 0>, <size = 15, stride = 64>, <size = 64, stride = 960>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 11 : i32}
      aiex.dma_start_task(%0)
      %1 = aiex.dma_configure_task_for @B_L3L2_shim_alloc {
        aie.dma_bd(%arg1 : memref<960x384xbf16>, 0, 368640, [<size = 1, stride = 0>, <size = 12, stride = 32>, <size = 960, stride = 384>, <size = 32, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%1)
      %2 = aiex.dma_configure_task_for @C_L2L3_shim_alloc {
        aie.dma_bd(%arg2 : memref<256x384xf32>, 0, 24576, [<size = 1, stride = 0>, <size = 12, stride = 32>, <size = 64, stride = 384>, <size = 32, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      ...
      %3 = aiex.dma_configure_task_for @A_L3L2_shim_alloc {
        aie.dma_bd(%arg0 : memref<256x960xbf16>, 61440, 61440, [<size = 12, stride = 0>, <size = 15, stride = 64>, <size = 64, stride = 960>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 11 : i32}
      ...
      %5 = aiex.dma_configure_task_for @C_L2L3_shim_alloc {
        aie.dma_bd(%arg2 : memref<256x384xf32>, 24576, 24576, [<size = 1, stride = 0>, <size = 12, stride = 32>, <size = 64, stride = 384>, <size = 32, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      ...
      %6 = aiex.dma_configure_task_for @A_L3L2_shim_alloc {
        aie.dma_bd(%arg0 : memref<256x960xbf16>, 122880, 61440, [<size = 12, stride = 0>, <size = 15, stride = 64>, <size = 64, stride = 960>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 11 : i32}
      ...
      %8 = aiex.dma_configure_task_for @C_L2L3_shim_alloc {
        aie.dma_bd(%arg2 : memref<256x384xf32>, 49152, 24576, [<size = 1, stride = 0>, <size = 12, stride = 32>, <size = 64, stride = 384>, <size = 32, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      ...
      %9 = aiex.dma_configure_task_for @A_L3L2_shim_alloc {
        aie.dma_bd(%arg0 : memref<256x960xbf16>, 184320, 61440, [<size = 12, stride = 0>, <size = 15, stride = 64>, <size = 64, stride = 960>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 11 : i32}
      ...
      %11 = aiex.dma_configure_task_for @C_L2L3_shim_alloc {
        aie.dma_bd(%arg2 : memref<256x384xf32>, 73728, 24576, [<size = 1, stride = 0>, <size = 12, stride = 32>, <size = 64, stride = 384>, <size = 32, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
