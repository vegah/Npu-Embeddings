module {
  aie.device(npu2) {
    ...
    aie.runtime_sequence(%arg0: memref<256x384xbf16>, %arg1: memref<384x384xbf16>, %arg2: memref<256x384xf32>) {
      ...
      %0 = aiex.dma_configure_task_for @A_L3L2_shim_alloc {
        aie.dma_bd(%arg0 : memref<256x384xbf16>, 0, 24576, [<size = 12, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 11 : i32}
      aiex.dma_start_task(%0)
      %1 = aiex.dma_configure_task_for @B_L3L2_shim_alloc {
        aie.dma_bd(%arg1 : memref<384x384xbf16>, 0, 147456, [<size = 1, stride = 0>, <size = 12, stride = 32>, <size = 384, stride = 384>, <size = 32, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      ...
      %3 = aiex.dma_configure_task_for @A_L3L2_shim_alloc {
        aie.dma_bd(%arg0 : memref<256x384xbf16>, 24576, 24576, [<size = 12, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 11 : i32}
      ...
      %6 = aiex.dma_configure_task_for @A_L3L2_shim_alloc {
        aie.dma_bd(%arg0 : memref<256x384xbf16>, 49152, 24576, [<size = 12, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 11 : i32}
      ...
      %9 = aiex.dma_configure_task_for @A_L3L2_shim_alloc {
        aie.dma_bd(%arg0 : memref<256x384xbf16>, 73728, 24576, [<size = 12, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 11 : i32}
