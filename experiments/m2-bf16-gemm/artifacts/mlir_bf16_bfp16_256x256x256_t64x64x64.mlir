module {
  aie.device(npu2) {
    ...
    func.func private @"964579b2_matmul_bf16_bf16"(memref<4096xbf16>, memref<4096xbf16>, memref<4096xbf16>) attributes {link_with = "matmul_bf16_bf16_964579b2.o"}
    ...
    ^bb21(%20: memref<4096xbf16>):  // 3 preds: ^bb18, ^bb19, ^bb20
      func.call @"964579b2_matmul_bf16_bf16"(%16, %20, %7) : (memref<4096xbf16>, memref<4096xbf16>, memref<4096xbf16>) -> ()
    ...
    ^bb24:  // pred: ^bb1
      aie.end
    } {link_files = ["matmul_bf16_bf16_964579b2.o"]}
    ...
    ^bb16:  // 2 preds: ^bb15, ^bb17
      ...
      aie.dma_bd(%C_L1L2_cons_buff_0 : memref<4096xbf16>, 0, 4096, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {bd_id = 6 : i32, next_bd_id = 7 : i32}
      aie.use_lock(%C_L1L2_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb17
    ^bb17:  // pred: ^bb16
      aie.use_lock(%C_L1L2_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%C_L1L2_cons_buff_1 : memref<4096xbf16>, 0, 4096, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {bd_id = 7 : i32, next_bd_id = 6 : i32}
      aie.use_lock(%C_L1L2_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb16
    ^bb18:  // pred: ^bb15
      aie.end
