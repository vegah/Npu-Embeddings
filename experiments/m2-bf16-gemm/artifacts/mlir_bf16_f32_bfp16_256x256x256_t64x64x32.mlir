module {
  aie.device(npu2) {
    ...
    aie.runtime_sequence(%arg0: memref<256x256xbf16>, %arg1: memref<256x256xbf16>, %arg2: memref<256x256xf32>) {
      ...
      %0 = aiex.dma_configure_task_for @A_L3L2_shim_alloc {
        aie.dma_bd(%arg0 : memref<256x256xbf16>, 0, 16384, [<size = 8, stride = 0>, <size = 4, stride = 64>, <size = 64, stride = 256>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%0)
      %1 = aiex.dma_configure_task_for @B_L3L2_shim_alloc {
        aie.dma_bd(%arg1 : memref<256x256xbf16>, 0, 65536, [<size = 1, stride = 0>, <size = 8, stride = 32>, <size = 256, stride = 256>, <size = 32, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%1)
      %2 = aiex.dma_configure_task_for @C_L2L3_shim_alloc {
        aie.dma_bd(%arg2 : memref<256x256xf32>, 0, 16384, [<size = 1, stride = 0>, <size = 8, stride = 32>, <size = 64, stride = 256>, <size = 32, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      ...
      %3 = aiex.dma_configure_task_for @A_L3L2_shim_alloc {
        aie.dma_bd(%arg0 : memref<256x256xbf16>, 16384, 16384, [<size = 8, stride = 0>, <size = 4, stride = 64>, <size = 64, stride = 256>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      ...
      %5 = aiex.dma_configure_task_for @C_L2L3_shim_alloc {
        aie.dma_bd(%arg2 : memref<256x256xf32>, 16384, 16384, [<size = 1, stride = 0>, <size = 8, stride = 32>, <size = 64, stride = 256>, <size = 32, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      ...
      %6 = aiex.dma_configure_task_for @A_L3L2_shim_alloc {
        aie.dma_bd(%arg0 : memref<256x256xbf16>, 32768, 16384, [<size = 8, stride = 0>, <size = 4, stride = 64>, <size = 64, stride = 256>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      ...
      %8 = aiex.dma_configure_task_for @C_L2L3_shim_alloc {
        aie.dma_bd(%arg2 : memref<256x256xf32>, 32768, 16384, [<size = 1, stride = 0>, <size = 8, stride = 32>, <size = 64, stride = 256>, <size = 32, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      ...
      %9 = aiex.dma_configure_task_for @A_L3L2_shim_alloc {
        aie.dma_bd(%arg0 : memref<256x256xbf16>, 49152, 16384, [<size = 8, stride = 0>, <size = 4, stride = 64>, <size = 64, stride = 256>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      ...
      %11 = aiex.dma_configure_task_for @C_L2L3_shim_alloc {
        aie.dma_bd(%arg2 : memref<256x256xf32>, 49152, 16384, [<size = 1, stride = 0>, <size = 8, stride = 32>, <size = 64, stride = 256>, <size = 32, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
