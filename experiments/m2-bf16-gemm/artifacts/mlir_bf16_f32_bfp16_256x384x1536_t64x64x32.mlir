module {
  aie.device(npu2) {
    ...
    aie.runtime_sequence(%arg0: memref<256x384xbf16>, %arg1: memref<384x1536xbf16>, %arg2: memref<256x1536xf32>) {
      ...
      %0 = aiex.dma_configure_task_for @A_L3L2_shim_alloc {
        aie.dma_bd(%arg0 : memref<256x384xbf16>, 0, 24576, [<size = 48, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 47 : i32}
      aiex.dma_start_task(%0)
      %1 = aiex.dma_configure_task_for @B_L3L2_shim_alloc {
        aie.dma_bd(%arg1 : memref<384x1536xbf16>, 0, 589824, [<size = 1, stride = 0>, <size = 48, stride = 32>, <size = 384, stride = 1536>, <size = 32, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%1)
      %2 = aiex.dma_configure_task_for @C_L2L3_shim_alloc {
        aie.dma_bd(%arg2 : memref<256x1536xf32>, 0, 98304, [<size = 1, stride = 0>, <size = 48, stride = 32>, <size = 64, stride = 1536>, <size = 32, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      ...
      %3 = aiex.dma_configure_task_for @A_L3L2_shim_alloc {
        aie.dma_bd(%arg0 : memref<256x384xbf16>, 24576, 24576, [<size = 48, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 47 : i32}
      ...
      %5 = aiex.dma_configure_task_for @C_L2L3_shim_alloc {
        aie.dma_bd(%arg2 : memref<256x1536xf32>, 98304, 98304, [<size = 1, stride = 0>, <size = 48, stride = 32>, <size = 64, stride = 1536>, <size = 32, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      ...
      %6 = aiex.dma_configure_task_for @A_L3L2_shim_alloc {
        aie.dma_bd(%arg0 : memref<256x384xbf16>, 49152, 24576, [<size = 48, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 47 : i32}
      ...
      %8 = aiex.dma_configure_task_for @C_L2L3_shim_alloc {
        aie.dma_bd(%arg2 : memref<256x1536xf32>, 196608, 98304, [<size = 1, stride = 0>, <size = 48, stride = 32>, <size = 64, stride = 1536>, <size = 32, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      ...
      %9 = aiex.dma_configure_task_for @A_L3L2_shim_alloc {
        aie.dma_bd(%arg0 : memref<256x384xbf16>, 73728, 24576, [<size = 48, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 47 : i32}
      ...
      %11 = aiex.dma_configure_task_for @C_L2L3_shim_alloc {
        aie.dma_bd(%arg2 : memref<256x1536xf32>, 294912, 98304, [<size = 1, stride = 0>, <size = 48, stride = 32>, <size = 64, stride = 1536>, <size = 32, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
