  ...
  aie.device(npu2) {
    ...
    aie.runtime_sequence(%arg0: memref<393216xbf16>, %arg1: memref<589824xbf16>, %arg2: memref<98304xf32>) {
      ...
      %2 = aiex.dma_configure_task_for @B_L3L2_0_shim_alloc {
        aie.dma_bd(%arg1 : memref<589824xbf16>, 0, 73728, [<size = 2, stride = 192>, <size = 24, stride = 24576>, <size = 64, stride = 384>, <size = 48, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      ...
      %5 = aiex.dma_configure_task_for @B_L3L2_1_shim_alloc {
        aie.dma_bd(%arg1 : memref<589824xbf16>, 48, 73728, [<size = 2, stride = 192>, <size = 24, stride = 24576>, <size = 64, stride = 384>, <size = 48, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      ...
      %8 = aiex.dma_configure_task_for @B_L3L2_2_shim_alloc {
        aie.dma_bd(%arg1 : memref<589824xbf16>, 96, 73728, [<size = 2, stride = 192>, <size = 24, stride = 24576>, <size = 64, stride = 384>, <size = 48, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      ...
      %11 = aiex.dma_configure_task_for @B_L3L2_3_shim_alloc {
        aie.dma_bd(%arg1 : memref<589824xbf16>, 144, 73728, [<size = 2, stride = 192>, <size = 24, stride = 24576>, <size = 64, stride = 384>, <size = 48, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
