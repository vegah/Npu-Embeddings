  ...
  aie.device(npu2) {
    ...
    aie.runtime_sequence(%arg0: memref<196608xbf16>, %arg1: memref<589824xbf16>, %arg2: memref<786432xf32>) {
      ...
      %1 = aiex.dma_configure_task_for @A_L3L2_0_shim_alloc {
        aie.dma_bd(%arg0 : memref<196608xbf16>, 0, 24576, [<size = 8, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      ...
      %3 = aiex.dma_configure_task_for @A_L3L2_0_shim_alloc {
        aie.dma_bd(%arg0 : memref<196608xbf16>, 98304, 24576, [<size = 8, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      ...
      %6 = aiex.dma_configure_task_for @A_L3L2_1_shim_alloc {
        aie.dma_bd(%arg0 : memref<196608xbf16>, 24576, 24576, [<size = 8, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      ...
      %8 = aiex.dma_configure_task_for @A_L3L2_1_shim_alloc {
        aie.dma_bd(%arg0 : memref<196608xbf16>, 122880, 24576, [<size = 8, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      ...
      %11 = aiex.dma_configure_task_for @A_L3L2_2_shim_alloc {
        aie.dma_bd(%arg0 : memref<196608xbf16>, 49152, 24576, [<size = 8, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      ...
      %13 = aiex.dma_configure_task_for @A_L3L2_2_shim_alloc {
        aie.dma_bd(%arg0 : memref<196608xbf16>, 147456, 24576, [<size = 8, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      ...
      %16 = aiex.dma_configure_task_for @A_L3L2_3_shim_alloc {
        aie.dma_bd(%arg0 : memref<196608xbf16>, 73728, 24576, [<size = 8, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      ...
      %18 = aiex.dma_configure_task_for @A_L3L2_3_shim_alloc {
        aie.dma_bd(%arg0 : memref<196608xbf16>, 172032, 24576, [<size = 8, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
