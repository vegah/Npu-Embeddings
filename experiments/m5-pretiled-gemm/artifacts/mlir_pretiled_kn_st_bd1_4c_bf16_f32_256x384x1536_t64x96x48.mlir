module {
  aie.device(npu2) {
    ...
    aie.runtime_sequence(%arg0: memref<98304xbf16>, %arg1: memref<589824xbf16>, %arg2: memref<393216xf32>) {
      ...
      %0 = aiex.dma_configure_task_for @C_L2L3_0_shim_alloc {
        aie.dma_bd(%arg2 : memref<393216xf32>, 0, 98304, [<size = 1, stride = 0>, <size = 8, stride = 192>, <size = 256, stride = 1536>, <size = 48, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%0)
      %1 = aiex.dma_configure_task_for @A_L3L2_0_shim_alloc {
        aie.dma_bd(%arg0 : memref<98304xbf16>, 0, 24576, [<size = 8, stride = 0>, <size = 4, stride = 96>, <size = 64, stride = 384>, <size = 96, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      ...
      %3 = aiex.dma_configure_task_for @C_L2L3_1_shim_alloc {
        aie.dma_bd(%arg2 : memref<393216xf32>, 48, 98304, [<size = 1, stride = 0>, <size = 8, stride = 192>, <size = 256, stride = 1536>, <size = 48, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%3)
      %4 = aiex.dma_configure_task_for @A_L3L2_1_shim_alloc {
        aie.dma_bd(%arg0 : memref<98304xbf16>, 24576, 24576, [<size = 8, stride = 0>, <size = 4, stride = 96>, <size = 64, stride = 384>, <size = 96, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      ...
      %6 = aiex.dma_configure_task_for @C_L2L3_2_shim_alloc {
        aie.dma_bd(%arg2 : memref<393216xf32>, 96, 98304, [<size = 1, stride = 0>, <size = 8, stride = 192>, <size = 256, stride = 1536>, <size = 48, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%6)
      %7 = aiex.dma_configure_task_for @A_L3L2_2_shim_alloc {
        aie.dma_bd(%arg0 : memref<98304xbf16>, 49152, 24576, [<size = 8, stride = 0>, <size = 4, stride = 96>, <size = 64, stride = 384>, <size = 96, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      ...
      %9 = aiex.dma_configure_task_for @C_L2L3_3_shim_alloc {
        aie.dma_bd(%arg2 : memref<393216xf32>, 144, 98304, [<size = 1, stride = 0>, <size = 8, stride = 192>, <size = 256, stride = 1536>, <size = 48, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%9)
      %10 = aiex.dma_configure_task_for @A_L3L2_3_shim_alloc {
        aie.dma_bd(%arg0 : memref<98304xbf16>, 73728, 24576, [<size = 8, stride = 0>, <size = 4, stride = 96>, <size = 64, stride = 384>, <size = 96, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
