module {
  aie.device(npu2) {
    ...
    aie.runtime_sequence(%arg0: memref<393216xbf16>, %arg1: memref<589824xbf16>, %arg2: memref<98304xf32>) {
      ...
      %0 = aiex.dma_configure_task_for @C_L2L3_0_shim_alloc {
        aie.dma_bd(%arg2 : memref<98304xf32>, 0, 24576, [<size = 1, stride = 0>, <size = 2, stride = 192>, <size = 256, stride = 384>, <size = 48, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%0)
      %1 = aiex.dma_configure_task_for @A_L3L2_0_shim_alloc {
        aie.dma_bd(%arg0 : memref<393216xbf16>, 0, 98304, [<size = 2, stride = 0>, <size = 24, stride = 64>, <size = 64, stride = 1536>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      ...
      %3 = aiex.dma_configure_task_for @C_L2L3_1_shim_alloc {
        aie.dma_bd(%arg2 : memref<98304xf32>, 48, 24576, [<size = 1, stride = 0>, <size = 2, stride = 192>, <size = 256, stride = 384>, <size = 48, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%3)
      %4 = aiex.dma_configure_task_for @A_L3L2_1_shim_alloc {
        aie.dma_bd(%arg0 : memref<393216xbf16>, 98304, 98304, [<size = 2, stride = 0>, <size = 24, stride = 64>, <size = 64, stride = 1536>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      ...
      %6 = aiex.dma_configure_task_for @C_L2L3_2_shim_alloc {
        aie.dma_bd(%arg2 : memref<98304xf32>, 96, 24576, [<size = 1, stride = 0>, <size = 2, stride = 192>, <size = 256, stride = 384>, <size = 48, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%6)
      %7 = aiex.dma_configure_task_for @A_L3L2_2_shim_alloc {
        aie.dma_bd(%arg0 : memref<393216xbf16>, 196608, 98304, [<size = 2, stride = 0>, <size = 24, stride = 64>, <size = 64, stride = 1536>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      ...
      %9 = aiex.dma_configure_task_for @C_L2L3_3_shim_alloc {
        aie.dma_bd(%arg2 : memref<98304xf32>, 144, 24576, [<size = 1, stride = 0>, <size = 2, stride = 192>, <size = 256, stride = 384>, <size = 48, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%9)
      %10 = aiex.dma_configure_task_for @A_L3L2_3_shim_alloc {
        aie.dma_bd(%arg0 : memref<393216xbf16>, 294912, 98304, [<size = 2, stride = 0>, <size = 24, stride = 64>, <size = 64, stride = 1536>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
