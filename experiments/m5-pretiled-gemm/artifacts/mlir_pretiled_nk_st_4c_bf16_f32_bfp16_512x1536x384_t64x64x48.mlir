  ...
  aie.device(npu2) {
    ...
    aie.runtime_sequence(%arg0: memref<786432xbf16>, %arg1: memref<589824xbf16>, %arg2: memref<196608xf32>) {
      ...
      %2 = aiex.dma_configure_task_for @B_L3L2_0_shim_alloc {
        aie.dma_bd(%arg1 : memref<589824xbf16>, 0, 73728, [<size = 2, stride = 294912>, <size = 24, stride = 3072>, <size = 64, stride = 48>, <size = 48, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      ...
      %7 = aiex.dma_configure_task_for @B_L3L2_1_shim_alloc {
        aie.dma_bd(%arg1 : memref<589824xbf16>, 73728, 73728, [<size = 2, stride = 294912>, <size = 24, stride = 3072>, <size = 64, stride = 48>, <size = 48, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      ...
      %12 = aiex.dma_configure_task_for @B_L3L2_2_shim_alloc {
        aie.dma_bd(%arg1 : memref<589824xbf16>, 147456, 73728, [<size = 2, stride = 294912>, <size = 24, stride = 3072>, <size = 64, stride = 48>, <size = 48, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      ...
      %17 = aiex.dma_configure_task_for @B_L3L2_3_shim_alloc {
        aie.dma_bd(%arg1 : memref<589824xbf16>, 221184, 73728, [<size = 2, stride = 294912>, <size = 24, stride = 3072>, <size = 64, stride = 48>, <size = 48, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
