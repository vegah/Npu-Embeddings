module {
  aie.device(npu2) {
    ...
    aie.runtime_sequence(%arg0: memref<196608xbf16>, %arg1: memref<147456xbf16>, %arg2: memref<196608xf32>) {
      ...
      %1 = aiex.dma_configure_task_for @A_L3L2_0_shim_alloc {
        aie.dma_bd(%arg0 : memref<196608xbf16>, 0, 24576, [<size = 2, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%1)
      %2 = aiex.dma_configure_task_for @B_L3L2_0_shim_alloc {
        aie.dma_bd(%arg1 : memref<147456xbf16>, 0, 18432, [<size = 2, stride = 12288>, <size = 6, stride = 24576>, <size = 64, stride = 48>, <size = 48, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%2)
      %3 = aiex.dma_configure_task_for @A_L3L2_0_shim_alloc {
        aie.dma_bd(%arg0 : memref<196608xbf16>, 98304, 24576, [<size = 2, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      ...
      %6 = aiex.dma_configure_task_for @A_L3L2_1_shim_alloc {
        aie.dma_bd(%arg0 : memref<196608xbf16>, 24576, 24576, [<size = 2, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%6)
      %7 = aiex.dma_configure_task_for @B_L3L2_1_shim_alloc {
        aie.dma_bd(%arg1 : memref<147456xbf16>, 3072, 18432, [<size = 2, stride = 12288>, <size = 6, stride = 24576>, <size = 64, stride = 48>, <size = 48, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%7)
      %8 = aiex.dma_configure_task_for @A_L3L2_1_shim_alloc {
        aie.dma_bd(%arg0 : memref<196608xbf16>, 122880, 24576, [<size = 2, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      ...
      %11 = aiex.dma_configure_task_for @A_L3L2_2_shim_alloc {
        aie.dma_bd(%arg0 : memref<196608xbf16>, 49152, 24576, [<size = 2, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%11)
      %12 = aiex.dma_configure_task_for @B_L3L2_2_shim_alloc {
        aie.dma_bd(%arg1 : memref<147456xbf16>, 6144, 18432, [<size = 2, stride = 12288>, <size = 6, stride = 24576>, <size = 64, stride = 48>, <size = 48, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%12)
      %13 = aiex.dma_configure_task_for @A_L3L2_2_shim_alloc {
        aie.dma_bd(%arg0 : memref<196608xbf16>, 147456, 24576, [<size = 2, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      ...
      %16 = aiex.dma_configure_task_for @A_L3L2_3_shim_alloc {
        aie.dma_bd(%arg0 : memref<196608xbf16>, 73728, 24576, [<size = 2, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%16)
      %17 = aiex.dma_configure_task_for @B_L3L2_3_shim_alloc {
        aie.dma_bd(%arg1 : memref<147456xbf16>, 9216, 18432, [<size = 2, stride = 12288>, <size = 6, stride = 24576>, <size = 64, stride = 48>, <size = 48, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%17)
      %18 = aiex.dma_configure_task_for @A_L3L2_3_shim_alloc {
        aie.dma_bd(%arg0 : memref<196608xbf16>, 172032, 24576, [<size = 2, stride = 0>, <size = 6, stride = 64>, <size = 64, stride = 384>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
